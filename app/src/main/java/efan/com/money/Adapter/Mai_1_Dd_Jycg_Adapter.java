...
public class Mai_1_Dd_Jycg_Adapter extends BaseAdapter {
    ...
    public void init(List<Mai_1_Dd_Jycg_Bean> list) {
        this.list = list;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = View.inflate(context, R.layout.mai_1_dd_jycg_item, null);
            holder.mai_1_dd_jycg_item_time = (TextView) view.findViewById(R.id.mai_1_dd_jycg_item_time);
            holder.mai_1_dd_jycg_item_lx = (TextView) view.findViewById(R.id.mai_1_dd_jycg_item_lx);
            holder.mai_1_dd_jycg_item_rwm = (TextView) view.findViewById(R.id.mai_1_dd_jycg_item_rwm);
            holder.mai_1_dd_jycg_item_yhm = (TextView) view.findViewById(R.id.mai_1_dd_jycg_item_yhm);
            holder.mai_1_dd_jycg_item_jg = (TextView) view.findViewById(R.id.mai_1_dd_jycg_item_jg);
            holder.mai_1_dd_jycg_item_tupian = (ImageView) view.findViewById(R.id.mai_1_dd_jycg_item_tupian);
            view.setTag(holder);
        } else {
    ...
    class ViewHolder {
        ...
        private ImageView mai_1_dd_jycg_item_tupian;
