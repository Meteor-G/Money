...
public class Mai_1_Dd_Qbrw_Adapter extends BaseAdapter {
    private Context context;
    private List<Mai_1_Dd_Qbrw_Bean> list = new ArrayList<Mai_1_Dd_Qbrw_Bean>();
    private LayoutInflater layoutInflater;

    public Mai_1_Dd_Qbrw_Adapter(Context context) {
        this.context = context;
        layoutInflater = LayoutInflater.from(context);
    }

    public void init(List<Mai_1_Dd_Qbrw_Bean> list) {
        this.list = list;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = View.inflate(context, R.layout.mai_1_dd_qbrw_item, null);
            holder.mai_1_dd_qbrw_item_time = (TextView) view.findViewById(R.id.mai_1_dd_qbrw_item_time);
            holder.mai_1_dd_qbrw_item_lx = (TextView) view.findViewById(R.id.mai_1_dd_qbrw_item_lx);
            holder.mai_1_dd_qbrw_item_rwm = (TextView) view.findViewById(R.id.mai_1_dd_qbrw_item_rwm);
            holder.mai_1_dd_qbrw_item_yhm = (TextView) view.findViewById(R.id.mai_1_dd_qbrw_item_yhm);
            holder.mai_1_dd_qbrw_item_zt = (TextView) view.findViewById(R.id.mai_1_dd_qbrw_item_zt);
            holder.mai_1_dd_qbrw_item_tupian = (ImageView) view.findViewById(R.id.mai_1_dd_qbrw_item_tupian);
            view.setTag(holder);
        } else {
