...
public class Mai_Fd_Dd_Qbrw_Adapter extends RecyclerView.Adapter<Mai_Fd_Dd_Qbrw_Adapter.ViewHolder> {
    ...
    private List<Mai_Fd_Dd_Qbrw_Bean> list = new ArrayList<>();
    private OnItemClickListener mItemClickListener;

    public Mai_Fd_Dd_Qbrw_Adapter(Context context, List<Mai_Fd_Dd_Qbrw_Bean> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.mai_fd_dd_qbrw_item_time.setText(list.get(position).getMai_fd_dd_qbrw_item_time());
        holder.mai_fd_dd_qbrw_item_lx.setText(list.get(position).getMai_fd_dd_qbrw_item_lx());
        holder.mai_fd_dd_qbrw_item_rwm.setText(list.get(position).getMai_fd_dd_qbrw_item_rwm());
        holder.mai_fd_dd_qbrw_item_yhm.setText(list.get(position).getMai_fd_dd_qbrw_item_yhm());
        holder.mai_fd_dd_qbrw_item_zt.setText(list.get(position).getMai_fd_dd_qbrw_item_zt());
        holder.mai_fd_dd_qbrw_item_tupian.setBackgroundResource(list.get(position).getMai_fd_dd_qbrw_tupian());
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView mai_fd_dd_qbrw_item_tupian;
        ...
        public ViewHolder(View itemView) {
            ...
            mai_fd_dd_qbrw_item_tupian = (ImageView) itemView.findViewById(R.id.mai_fd_dd_qbrw_item_tupian);
        }
    }
