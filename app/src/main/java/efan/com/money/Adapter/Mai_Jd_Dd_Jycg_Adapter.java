...
public class Mai_Jd_Dd_Jycg_Adapter extends RecyclerView.Adapter<Mai_Jd_Dd_Jycg_Adapter.ViewHolder> {
    ...
    public Mai_Jd_Dd_Jycg_Adapter(Context context, List<Mai_1_Dd_Jycg_Bean> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.mai_1_dd_jycg_item, null);
