...
public class Mai_1_Fragment extends Fragment implements View.OnClickListener {
    private View view;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mai_1_fra_zhbd:
                Intent intent = new Intent(getActivity(), Mai_1_Zhbd.class);
    ...
    private void intent_class(int i) {
        ...
        Intent intent = new Intent(getActivity(), Mai_1_Digdan.class);
