...
import efan.com.money.Adapter.Mai_Fd_Dd_Rwyl_Adapter;
...
public class Mai_Fd_Dd_Rwyl extends Fragment implements OnItemClickListener {
    private View view;
    ...
    private SuperSwipeRefreshLayout mai_fd_dd_rwyl_refresh;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.mai_2_dd_rwyl, container, false);
        }
    ...
    private void GetListData(int page) {
        adapter = new Mai_Fd_Dd_Rwyl_Adapter(getActivity());
        adapter.setOnItemClickListener(this);
        RxRestClient.builder()
                .url(StaticUrl.GET_USER_FA_DAN)
                    ...
                    public void onNext(String s) {
                        if (object.parseObject(s).getString("success").equals("true")) {
                            ...
                            if (AllList.size() != 0) {
                                ...
                                mai_fd_dd_rwyl_rl.setVisibility(View.VISIBLE);
                            }
                            //更新数据后控件变化及更新adapter
    ...
    private void Refresh() {
        mai_fd_dd_rwyl_refresh.setHeaderView(createHeaderView());// add headerView
        mai_fd_dd_rwyl_refresh.setFooterView(createFooterView());
        //设置下拉时，被包含的View是否随手指的移动而移动   true跟随   false不跟随
        mai_fd_dd_rwyl_refresh.setTargetScrollWithLayout(true);
        //设置默认圆形的阴影颜色
        mai_fd_dd_rwyl_refresh.setDefaultCircleShadowColor(R.color.colorPrimaryDark);
        //设置默认圆形背景色
        mai_fd_dd_rwyl_refresh.setDefaultCircleBackgroundColor(R.color.white);
        //设置默认圆形进度条颜色
        mai_fd_dd_rwyl_refresh.setDefaultCircleProgressColor(R.color.colorAccent);
        mai_fd_dd_rwyl_refresh.setOnPullRefreshListener(new SuperSwipeRefreshLayout.OnPullRefreshListener() {
            @Override
         ...
         * 上拉加载更多
         */
        mai_fd_dd_rwyl_refresh.setOnPushLoadMoreListener(new SuperSwipeRefreshLayout.OnPushLoadMoreListener() {
            @Override
            public void onLoadMore() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        GetListData(PAGE);
                        mai_fd_dd_rwyl_refresh.setLoadMore(false);
                        progressBar.setVisibility(View.GONE);
                    }
                }, 1000);
            }
    ...
    private void InitView() {
        mai_fd_dd_rwyl_refresh = (SuperSwipeRefreshLayout) view.findViewById(R.id.mai_fd_dd_rwyl_refresh);
        mai_fd_dd_rwyl_recycle = (RecyclerView) view.findViewById(R.id.mai_fd_dd_rwyl_recycle);
        LinearLayoutManager manager = new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        mai_fd_dd_rwyl_recycle.setLayoutManager(manager);
        mai_fd_dd_rwyl_rl = (RelativeLayout) view.findViewById(R.id.mai_fd_dd_rwyl_rl);
    }
