...
public class Mai_Fd_Dingdan extends FragmentActivity implements View.OnClickListener {
    ...
    private void InitView() {
        ...
        Fragment tab0 = new Mai_Fd_Dd_Rwyl();
        Fragment tab1 = new Mai_Fd_Dd_Jxs();
        Fragment tab2 = new Mai_Fd_Dd_Dsh();
        Fragment tab3 = new Mai_Fd_Dd_Jycg();
        Fragment tab4 = new Mai_Fd_Dd_Qbrw();
