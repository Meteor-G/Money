...
public class Mai_Jd_Dd_Jycg extends Fragment implements OnItemClickListener {
    private View view;
    // Header View
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("onCreateView", "Mai_Jd_Dd_Jycg" + System.currentTimeMillis());
        if (view == null) {
    ...
    public void onResume() {
        super.onResume();
        Log.i("onResume", "Mai_Jd_Dd_Jycg   " + getUserVisibleHint());
                ...
                .subscribe(new BaseSubscriber<String>(getActivity()) {
                    ...
                    public void onNext(String s) {
                        ...
                        if (object.parseObject(s).getString("success").equals("true")) {
                            ...
                            if (PAGE != 0) {
                                mai_jd_dd_jycg_recycle.scrollToPosition(adapter.getItemCount() - jycg_List.size() - 1);
                            }
    ...
    private void Refresh() {
        mai_jd_dd_jycg_refresh.setHeaderView(createHeaderView());// add headerView
        mai_jd_dd_jycg_refresh.setFooterView(createFooterView());
        //设置下拉时，被包含的View是否随手指的移动而移动   true跟随   false不跟随
        mai_jd_dd_jycg_refresh.setTargetScrollWithLayout(true);
        //设置默认圆形的阴影颜色
        mai_jd_dd_jycg_refresh.setDefaultCircleShadowColor(R.color.colorPrimaryDark);
        //设置默认圆形背景色
        mai_jd_dd_jycg_refresh.setDefaultCircleBackgroundColor(R.color.white);
        //设置默认圆形进度条颜色
        mai_jd_dd_jycg_refresh.setDefaultCircleProgressColor(R.color.colorAccent);
        mai_jd_dd_jycg_refresh.setOnPullRefreshListener(new SuperSwipeRefreshLayout.OnPullRefreshListener() {
            @Override
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        Jycg_AllList.clear();
                        GetListData(0);
                        mai_jd_dd_jycg_refresh.setRefreshing(false);
         ...
         * 上拉加载更多
         */
        mai_jd_dd_jycg_refresh.setOnPushLoadMoreListener(new SuperSwipeRefreshLayout.OnPushLoadMoreListener() {
            @Override
            public void onLoadMore() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        GetListData(PAGE);
                        mai_jd_dd_jycg_refresh.setLoadMore(false);
                        progressBar.setVisibility(View.GONE);
                    }
                }, 1000);
            }
