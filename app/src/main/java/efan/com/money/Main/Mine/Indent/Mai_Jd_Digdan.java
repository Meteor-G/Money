...
public class Mai_Jd_Digdan extends FragmentActivity implements View.OnClickListener {
    ...
    private void InitView() {
        ...
        Fragment tab0 = new Mai_Jd_Dd_Jyz();
        Fragment tab1 = new Mai_Jd_Dd_Shz();
        Fragment tab2 = new Mai_Jd_Dd_Jycg();
        Fragment tab3 = new Mai_Jd_Dd_Qbrw();
