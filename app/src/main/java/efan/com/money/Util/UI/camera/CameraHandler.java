...
public class CameraHandler implements View.OnClickListener {
    ...
    public CameraHandler(BasePermissionActivity delegate) {
    ...
    private void takePhoto() {
        ...
        //FileUtil.CAMERA_PHOTO_DIR系统相册的路径
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            final Uri uri = DELEGATE.getContentResolver().
                    insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, contentValues);
            //需要讲Uri路径转化为实际路径
            final File realFile =
                    FileUtils.getFileByPath(FileUtil.getRealFilePath(DELEGATE, uri));
